...
import { Brain, HelpCircle, Timer, Trophy } from 'lucide-react';
import { aiQuestions } from '../data/aiQuestions';

const QUESTION_TIME_LIMIT = 105;
...
export default function AIQuiz() {
  ...
  const getScoreMessage = () => {
    const percentage = (score / aiQuestions.length) * 100;
    if (percentage >= 90) return "🏆 Extraordinary! You're an AI Genius! 🌟";
    if (percentage >= 80) return "🎯 Excellent! You're an AI Master! 🚀";
          ...
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-6 rounded-lg mb-6 border border-gray-700">
              <p className="text-2xl font-bold mb-2 text-gray-100">
                Final Score: {score}/{aiQuestions.length} 🎯
              </p>
              <p className="text-lg text-cyan-400">
                {((score / aiQuestions.length) * 100).toFixed(1)}% Correct
              </p>
            </div>
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-300">
              Question {currentQuestionIndex + 1}/{aiQuestions.length}
            </span>
          </div>
